	...
	*/
    const Features = () => (
      ...
      <div className= "apiSplash">
				<a href={`${siteConfig.baseUrl}docs/API/ScriptingLanguages`}>
				...
				<div className="apiText">
					...
					<p>Scripting opens up limitless possibilities in Enklu Cloud.  Check out our <a href={`${siteConfig.baseUrl}docs/API/ScriptingLanguages`}><strong>API Reference</strong></a> to see what APIs are currently supported, access code snippets that you can copy and paste into your own scripts, and learn about how you can utilize our APIs for your projects.</p>
				</div>
      </div>
    );
