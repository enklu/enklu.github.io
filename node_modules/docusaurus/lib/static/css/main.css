...
@keyframes selectionColor {
  0% {box-shadow: 
    	...
    	inset 0 0 4px rgba(51, 222, 210, 1);}
  50% {box-shadow: 
    	0 0 9px rgba(0, 0, 0, 0.15),
    	inset 0 0 14px rgba(49, 176, 209, 1);}
  100% {box-shadow: 
    	0 0 8px rgba(0, 0, 0, 0.05),
    	inset 0 0 24px rgba(92, 57, 188, 1);}
}

@keyframes buttonSelectionColor {
  0% {box-shadow: 
    	inset 0 0 2px rgba(51, 222, 210, 0.75);}
  50% {box-shadow: 
    	inset 0 0 8px rgba(49, 176, 209, 0.75);}
  100% {box-shadow: 
    	inset 0 0 14px rgba(92, 57, 188, 0.75);}
}
...
#back-to-top {
	background-color: rgba(51, 222, 210, 0.2); 
	box-shadow: 0 2px 5px 0 rgba(0,0,0,.2);
	transition: all 0.5s ease;
}

#back-to-top:hover{
	background-color: rgba(51, 222, 210, 1); 
...
/* Buttons */
.button {
  border: 1px solid $enkluBrandColor;
  border-radius: 8px;
  color: $primaryColor;
  display: inline-block;
  font-size: 14px;
...
.button:hover {
  animation: buttonSelectionColor 3s infinite alternate linear;
	font-weight: 600;
...
/* Blockquotes */
blockquote {
  background-color: rgba(51, 222, 210, 0.15);
  border-left: 8px solid #33DED2;
...
.mainContainer .wrapper .post .postFlex {
	align-items: center;
...
.mainContainer .wrapper .post .postFlex img {
	justify-content: flex-end;
	padding-right: 3em;
	position: absolute;
	right: 0;
...
.fixedHeaderContainer {
  /*background: $primaryColor;*/
  background-image: linear-gradient(135deg,  #33DED2, #31b0d1, #5C39BC);
  color: #fff;
  min-height: 50px;
  padding: 8px 0;
  position: fixed;
...
.navSearchWrapper .aa-dropdown-menu {
  ...
  border-width: 3px;
	border-style: solid;
	border-image: linear-gradient(45deg,  #33DED2, #31b0d1, #5C39BC) 1;
  color: #393939;
  font-size: 14px;
  left: auto !important;
  line-height: 1.2em;
...
.gridBlock > * {
  ...
  border: 0 !important;
  border-radius: 8px;
  box-shadow: 2px 2px 10px 0px #04070833;
  padding: 1.25rem;
  margin: 1em;
}
...
.gridBlock > *:hover {
  background-color: $backgroundColor;
  animation: selectionColor 5s infinite alternate linear;
}
...
.gridBlock .fourByGridBlock .blockContent h2{
  font-size: 1.25em;
}
/*
.gridBlock .fourByGridBlock .blockContent p{
  font-size: 0.8em;
}
*/
.highlightBackground {
...
.navigationSlider .slidingNav ul {
  ...
  background-image: linear-gradient(45deg,  #33DED2, #31b0d1, #5C39BC);
  box-sizing: border-box;
  color: #fff;
  display: flex;
  flex-wrap: nowrap;
...
.docsNavContainer .toc .navBreadcrumb {
  /*background-color: rgba(51, 222, 210, 0.2);*/
  background-image: linear-gradient(135deg,  rgba(91, 197, 195, 0.3), rgba(49, 176, 209, 0.3), rgba(91, 88, 166, 0.3));
  box-sizing: border-box;
  display: flex;
  flex-flow: row nowrap;
  font-size: 12px;
...
.docsNavContainer::-webkit-scrollbar-thumb {
  background-image: linear-gradient(135deg,  rgba(51, 222, 210,0.25), rgba(51, 222, 210, 0.75));
	border-radius: 10px;
}
...
.nav-footer {
  /*background: #20232a;*/
  background-image: linear-gradient(135deg,  #255150, #144856, #252444);
  border: none;
  color: #202020;
  font-size: 15px;
