...
@keyframes selectionColor {
  0% {box-shadow: 
    	...
    	inset 0 0 4px rgba(91, 197, 195, 1);}
  50% {box-shadow: 
    	0 0 9px rgba(0, 0, 0, 0.15),
    	inset 0 0 14px rgba(49, 176, 209, 1);}
  100% {box-shadow: 
    	0 0 8px rgba(0, 0, 0, 0.05),
    	inset 0 0 24px rgba(91, 88, 166, 1);}
}

@keyframes buttonSelectionColor {
  0% {box-shadow: 
    	0 0 4px rgba(0, 0, 0, 0.25),
    	inset 0 0 2px rgba(91, 197, 195, 0.75);}
  50% {box-shadow: 
    	0 0 4px rgba(0, 0, 0, 0.25),
    	inset 0 0 8px rgba(49, 176, 209, 0.75);}
  100% {box-shadow: 
    	0 0 4px rgba(0, 0, 0, 0.25),
    	inset 0 0 14px rgba(91, 88, 166, 0.75);}
}
...
.fixedHeaderContainer {
  /*background: $primaryColor;*/
  background-image: linear-gradient(135deg,  #5BC5C3, #31b0d1, #5B58A6);
  color: #fff;
  min-height: 50px;
  padding: 8px 0;
  position: fixed;
...
.navSearchWrapper .aa-dropdown-menu {
  ...
  border-width: 3px;
	border-style: solid;
	border-image: linear-gradient(45deg,  #5BC5C3, #31b0d1, #5B58A6) 1;
  color: #393939;
  font-size: 14px;
  left: auto !important;
  line-height: 1.2em;
...
.navigationSlider .slidingNav ul {
  ...
  background-image: linear-gradient(45deg,  #5BC5C3, #31b0d1, #5B58A6);
  box-sizing: border-box;
  color: #fff;
  display: flex;
  flex-wrap: nowrap;
