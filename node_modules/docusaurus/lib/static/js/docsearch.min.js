/*! docsearch 1.5.0 | © Algolia | github.com/algolia/docsearch */ ! function (t, e) {
	...
	return function (t) {
		...
		var o = Object.assign || function (t) {
			...
			x = function () {
				function t(e) {
					...
					}), this.apiKey = n, this.appId = u, this.indexName = r, this.input = t.getInputFromSelector(s), this.algoliaOptions = o({
						hitsPerPage: 5
					}, m);
				...
				return s(t, [{
					...
					key: "handleShown",
					value: function (t, e) {
						var n = t.offset().left + t.width() / 2,
							r = (0, w.default)(document).width() / 2;
						isNaN(r) && (r = 900);
						var i = n - r >= 0 ? "algolia-autocomplete-right" : "algolia-autocomplete-left",
							o = n - r < 0 ? "algolia-autocomplete-right" : "algolia-autocomplete-left",
							s = (0, w.default)(".algolia-autocomplete");
					...
					value: function (e) {
						...
						return w.default.each(i, function (t, e) {
							var n = y.default.groupBy(e, "lvl1"),
								r = y.default.flattenAndFlagFirst(n, "isSubCategoryHeader");
							i[t] = r
						}), i = y.default.flattenAndFlagFirst(i, "isCategoryHeader"), i.map(function (e) {
							var n = t.formatURL(e),
								r = y.default.getHighlightedValue(e, "lvl0"),
								i = y.default.getHighlightedValue(e, "lvl1") || r,
								o = i == r,
								s = y.default.compact([y.default.getHighlightedValue(e, "lvl2") || i, y.default.getHighlightedValue(e, "lvl3"), y.default.getHighlightedValue(e, "lvl4"), y.default.getHighlightedValue(e, "lvl5"), y.default.getHighlightedValue(e, "lvl6")]).join('<span class="aa-suggestion-title-separator" aria-hidden="true"> › </span>'),
								a = s == i,
								u = y.default.getSnippetedValue(e, "content"),
								c = i && "" != i || s && "" != s;
							return {
		...
		c(r, u), r.prototype.deleteIndex = function (t, e) {
			...
			var i = n(22),
				o = "Usage: client.addUserKey(arrayOfAcls[, params, callback])";
			...
			var o = n(22),
				s = "Usage: client.updateUserKey(key, arrayOfAcls[, params, callback])";
		...
		t.exports = r, i(r, o), r.prototype.addObject = function (t, e, n) {
			...
			var i = n(22),
				o = "Usage: index.addUserKey(arrayOfAcls[, params, callback])";
			if (!i(t)) throw new Error(o);
			1 !== arguments.length && "function" != typeof e || (r = e, e = null);
			var s = {
				acl: t
			...
			var o = n(22),
				s = "Usage: index.updateUserKey(key, arrayOfAcls[, params, callback])";
			if (!o(e)) throw new Error(s);
			2 !== arguments.length && "function" != typeof r || (i = r, r = null);
			var a = {
				acl: e
		...
		var r = Object.prototype.hasOwnProperty,
			...
			m = function (t) {
				...
				if (o && t.length > 0)
					...
					for (var y in t) p && "prototype" === y || !r.call(t, y) || h.push(String(y));
				if (u)
					for (var g = d(t), v = 0; v < l.length; ++v) g && "constructor" === l[v] || !r.call(t, l[v]) || h.push(l[v]);
				return h
			};
		m.shim = function () {
			if (Object.keys) {
		...
		r.prototype.initIndex = function (t) {
			...
			function e(n, c) {
				function p(t) {
					...
					var p = new u.AlgoliaSearchError(t.body && t.body.message, {
						debugData: g,
						statusCode: e
					});
				...
				if (d >= f.hosts[t.hostType].length) return !y || m ? (s("could not get any response"), f._promise.reject(new u.AlgoliaSearchError("Cannot connect to the AlgoliaSearch API. Send an email to support@algolia.com to report and resolve the issue. Application id was: " + f.applicationID, {
					debugData: g
				}))) : (s("switching to fallback"), d = 0, c.method = t.fallback.method, c.url = t.fallback.url, c.jsonBody = t.fallback.body, c.jsonBody && (c.body = o(c.jsonBody)), i = f._computeRequestHeaders(l), c.timeouts = f._getTimeoutsForRequest(t.hostType), f._setHostIndexByType(0, t.hostType), m = !0, e(f._request.fallback, c));
				var T = f._getHostByType(t.hostType),
					S = T + c.url,
					C = {
						body: c.body,
						jsonBody: c.jsonBody,
			...
			var r, i, s = n(29)("algoliasearch:" + t.url),
				l = t.additionalUA || "",
				h = t.cache,
				f = this,
				d = 0,
		...
		(function (e) {
			...
			var a, u = n(29)("algoliasearch:src/hostIndexState.js"),
		...
		t.exports = function (t, e) {
			...
			return p.hasXMLHttpRequest && (p.cors = "withCredentials" in new XMLHttpRequest), a(s, t), s.prototype._request = function (t, e) {
				return new i(function (n, r) {
					...
					t = c(t, e.headers);
					var f, d, m = e.body,
						y = p.cors ? new XMLHttpRequest : new XDomainRequest,
						g = !1;
		...
		function r(t, e, n) {
			...
			var f = document.getElementsByTagName("head")[0],
				...
				y = !1;
			window[m] = function (t) {
				return u(), p ? void e.debug("JSONP: Late answer, ignoring") : (h = !0, a(), void n(null, {
					body: t
				}))
		...
		var a = "aaAutocomplete",
			u = n(48),
			c = n(49);
		r.sources = u.sources;
		var l = "autocomplete" in window,
			h = window.autocomplete;
				...
				return X.matches = function (t, e) {
					...
					attr: function (t, e) {
						...
						return "string" != typeof t || 1 in arguments ? this.each(function (n) {
							if (1 === this.nodeType)
								...
								else b(this, t, v(this, e, n, this.getAttribute(t)))
					...
					css: function (t, n) {
						...
						if ("string" == e(t)) n || 0 === n ? s = l(t) + ":" + p(t, n) : this.each(function () {
							...
							for (S in t) t[S] || 0 === t[S] ? s += l(S) + ":" + p(S, t[S]) + ";" : this.each(function () {
		...
		for (var a, u, c, l = [n(53), n(54), n(55), n(56), n(57)], h = -1, p = [], f = !1, d = -1, m = l.length; ++d < m;)
			...
			_render: function (t, e) {
				...
				function r() {
					...
					var n, r, i = [].slice.call(arguments, 0),
						o = this,
						s = p.suggestions.replace("%PREFIX%", this.cssClasses.prefix).replace("%SUGGESTIONS%", this.cssClasses.suggestions);
		...
		var n = "algolia-docsearch",
			...
			o = {
				...
				footer: '\n    <div class="' + i + '">\n      <a class="' + i + '--logo" href="https://www.algolia.com/docsearch" target="_blank">Algolia</a>\n    </div>\n  '
			};
		...
		var r = function () {
			...
			return Q.matches = function (t, e) {
				...
				if (!t) return Q.Z();
				if ("string" == typeof t)
					if (t = t.trim(), "<" == t[0] && P.test(t)) r = Q.fragment(t, RegExp.$1, n), t = null;
					else {
					...
					else if (P.test(t)) r = Q.fragment(t.trim(), RegExp.$1, n), t = null;
					else {
						if (n !== _) return T(n).find(t);
						r = Q.qsa(j, t)
					}
				...
				css: function (e, n) {
					...
					if ("string" == t(e)) n || 0 === n ? s = c(e) + ":" + h(e, n) : this.each(function () {
						...
						for (x in e) e[x] || 0 === e[x] ? s += c(x) + ":" + h(x, e[x]) + ";" : this.each(function () {
		...
		window.Zepto = r, void 0 === window.$ && (window.$ = r),
			...
			function (t) {
				...
				C.href = window.location.href, t.active = 0, t.ajaxJSONP = function (e, n) {
					...
					if (u && u.promise(T), i.crossDomain || _("X-Requested-With", "XMLHttpRequest"), _("Accept", b || "*/*"), (b = i.mimeType || b) && (b.indexOf(",") > -1 && (b = b.split(",", 2)[0]), T.overrideMimeType && T.overrideMimeType(b)), (i.contentType || i.contentType !== !1 && i.data && "GET" != i.type.toUpperCase()) && _("Content-Type", i.contentType || "application/x-www-form-urlencoded"), i.headers)
						for (y in i.headers) _(y, i.headers[y]);
					...
					if (i.xhrFields)
						for (y in i.xhrFields) T[y] = i.xhrFields[y];
		...
		Object.defineProperty(e, "__esModule", {
			value: !0
		}), e.default = "1.5.0", t.exports = e.default
	}])
});
